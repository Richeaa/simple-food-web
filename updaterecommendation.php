        ...
        <div class="main-table">
            <div class="table2">
                ...
                <form action='' method='POST' class="form5">
                    ...
                    <input type='text' name='recommendation' id='recommendation' value='<?php echo $recommendation; ?>'>
                    <br>
                    <label for='city'>City</label><br>
                    <input type='text' name='city' id='city' value='<?php echo $city; ?>'>
                    <br><br>
                    <input type='submit' name='submit' value="Update Recommendation" class='addrecommendation'>
                </form>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "UPDATE recommendation SET name='$name', recommendation='$recommendation', city='$city' WHERE recommend_id='$recommend_id'";
                    $result = mysqli_query($conn, $sql);
